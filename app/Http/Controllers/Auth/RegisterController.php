...
class RegisterController extends Controller
{
    ...
    public $genders = array('male' => 'Male', 'female' => 'Female', 'other' => 'Other');
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('auth.register', compact('continents', 'countries', 'genders'));
    }
    ...
    protected function validator(array $data)
    {
        $messages = [
          ...
          'before' => 'Must be older than 13 years.',
        ];
        ...
        return Validator::make($data, [
            ...
            'contact_number' => 'required|numeric|digits_between:4,15',
    ...
    {
        session(['currentUserEmail' => $data['email']]);
