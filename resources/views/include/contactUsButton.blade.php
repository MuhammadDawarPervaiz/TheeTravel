<div class="arcontactus-message left active" id="arcontactus-widget">
    ...
    <div class="messangers-block">
        <a target="_blank" href="https://m.me/areamaDevelopment" class="messanger facebook">
            <span>
        ...
        <a target="_blank" href="https://t.me/areama" class="messanger telegram">
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <a target="_blank" href="https://p17arcu.areama.net/contact-us" class="messanger conact">
            <span>
    ...
    <div class="arcontactus-message-button">
        <div class="static">
            <img src="{{ URL::asset('call_button_files/img/msg.svg') }}" alt="Contact us">
            <p>Contact us</p>
        </div>
        ...
        <div class="arcontactus-close">
            <img src="{{ URL::asset('call_button_files/img/close.svg') }}" alt="Close">
        </div>
