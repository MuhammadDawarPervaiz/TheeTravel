<div id="profile" class="tab-pane fade">
    ...
    <div class="edit-profile">
        <form class="edit-profile-form" method="post" action="edit_profile">
            ...
            <div class="col-sm-9 no-padding no-float">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sms-6 col-sm-6">
                        ...
                        <input type="email" name="email_confirmation" class="input-text full-width">
                    </div>
                </div>
                <div class="row form-group">
                    <!--<div class="col-sms-6 col-sm-6">
                    ...
                    <div class="col-sms-6 col-sm-6">
                        ...
                        <input type="text" name="phone_number" class="input-text full-width" placeholder="">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sms-4 col-sm-2">
                        <div class="selector">
                            <select class="full-width" name="date">
                    ...
                    <div class="col-sms-4 col-sm-2">
                        <div class="selector">
                            <select class="full-width" name="month">
                    ...
                    <div class="col-sms-4 col-sm-2">
                        <div class="selector">
                            <select class="full-width" name="year">
                ...
                <div class="row form-group">
                    <div class="col-sms-6 col-sm-6">
                        ...
                        <input type="text" name="street_name" class="input-text full-width">
                    </div>
                    <div class="col-sms-6 col-sm-6">
                        <label>Address</label>
